...
<body>
    <nav class="navbar bg-dark text-white">
        <div class="container-fluid">
            <a class="navbar-brand text-white">Editar etiqueta</a>
            <div class="d-flex">
    ...
    <div class="p-4">
        ...
        <div class="mx-auto card p-2" style="width: 25rem;">
            <div class="card-body">
                ...
                <form:form method="POST" action="/promanager/usuario/etiquetas/quadro/${quadro.id}/etiqueta/${etiqueta.id}/salvar" modelAttribute="etiqueta" class="formulario child">
                <div class="row">
                    ...
                    <div class="col-12 mb-3">
                        ...
                        <br />
                        <form:select class="form-select" path="cor">
