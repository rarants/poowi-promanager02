...
<div>
    ...
    <div class="p-4">
        <div class="text-center mb-4">
            <h1>Bem vindo! <span class="text-primary">${usuario_logado.nome}</span></h1>
            <p class="h3">Meus quadros</p>
            <a href="/promanager/usuario/dashboard/quadros/novo" class="btn btn-primary btn-sm mt-4">
