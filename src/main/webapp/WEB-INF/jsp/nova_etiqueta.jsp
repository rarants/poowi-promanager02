...
<body>
    <nav class="navbar bg-dark text-white">
        <div class="container-fluid">
            <a class="navbar-brand text-white">Nova etiqueta</a>
            <div class="d-flex">
    ...
    <div class="p-4">
        <div class="text-center text-white">
            <h1>Nova etiqueta no quadro <span class="text-primary">${quadro.titulo}</span></h1>
            <p>
        ...
        <div class="mx-auto card p-2" style="width: 25rem;">
            <div class="card-body">
                <div class="card-title">Nova etiqueta</div>
                <%--@elvariable id="etiqueta" type="com.example.rarants_promanager.model.Etiqueta"--%>
                <form:form method="POST" action="/promanager/usuario/etiquetas/quadro/${quadro.id}/etiqueta/nova" modelAttribute="etiqueta" class="formulario child">
                <div class="row">
                    ...
                    <div class="col-12 mb-3">
                        <form:label path="cor" for="cor" class="form-label">Cor</form:label>
