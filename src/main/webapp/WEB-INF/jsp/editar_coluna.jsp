...
<body>
    ...
    <div class="p-4">
        <div class="text-center">
            <h1 class="text-white">Editar coluna <span class="text-primary">${coluna.titulo}</span>
                do quadro <strong>${quadro.titulo}</strong>
            </h1>
            <p class="text-white">
        ...
        <div class="mx-auto card mt-4 p-2" style="width: 25rem;">
            <div class="card-body">
                ...
                <form:form method="POST" action="/promanager/usuario/colunas/quadro/${quadro.id}/coluna/${coluna.id}/salvar" modelAttribute="coluna" class="formulario child">
                    <div class="row">
                    ...
                    <div class="text-center mt-3">
                        <a href="/promanager/usuario/colunas/quadro/${quadro.id}/coluna/${coluna.id}/remover" class="btn btn-danger btn-sm mb-3 ml-3 text-white">
                            Remover coluna
                        </a>
                    </div>
                </form:form>
