...
INSERT INTO pg_catalog.pg_views (schemaname, viewname, viewowner, definition) VALUES ('pg_catalog', 'pg_backend_memory_contexts', 'postgres', ' SELECT pg_get_backend_memory_contexts.name,
...
INSERT INTO pg_catalog.pg_views (schemaname, viewname, viewowner, definition) VALUES ('pg_catalog', 'pg_stat_wal', 'postgres', ' SELECT w.wal_records,
    w.wal_fpi,
    w.wal_bytes,
    w.wal_buffers_full,
    w.wal_write,
...
INSERT INTO pg_catalog.pg_views (schemaname, viewname, viewowner, definition) VALUES ('pg_catalog', 'pg_stat_progress_copy', 'postgres', ' SELECT s.pid,
    s.datid,
    d.datname,
    s.relid,
        CASE s.param5
...
INSERT INTO pg_catalog.pg_views (schemaname, viewname, viewowner, definition) VALUES ('pg_catalog', 'pg_stats_ext_exprs', 'postgres', ' SELECT cn.nspname AS schemaname,
    c.relname AS tablename,
    sn.nspname AS statistics_schemaname,
    s.stxname AS statistics_name,
    pg_get_userbyid(s.stxowner) AS statistics_owner,
...
INSERT INTO pg_catalog.pg_views (schemaname, viewname, viewowner, definition) VALUES ('pg_catalog', 'pg_stat_replication_slots', 'postgres', ' SELECT s.slot_name,
    s.spill_txns,
    s.spill_count,
    s.spill_bytes,
    s.stream_txns,
...
INSERT INTO pg_catalog.pg_views (schemaname, viewname, viewowner, definition) VALUES ('information_schema', 'check_constraint_routine_usage', 'postgres', ' SELECT DISTINCT (current_database())::information_schema.sql_identifier AS constraint_catalog,
...
INSERT INTO pg_catalog.pg_views (schemaname, viewname, viewowner, definition) VALUES ('information_schema', 'collation_character_set_applicability', 'postgres', ' SELECT (current_database())::information_schema.sql_identifier AS collation_catalog,
  ...
  WHERE ((c.collnamespace = nc.oid) AND (c.collencoding = ANY (ARRAY[''-1''::integer, ( SELECT pg_database.encoding
           FROM pg_database
          WHERE (pg_database.datname = current_database()))])));');
INSERT INTO pg_catalog.pg_views (schemaname, viewname, viewowner, definition) VALUES ('information_schema', 'column_column_usage', 'postgres', ' SELECT DISTINCT (current_database())::information_schema.sql_identifier AS table_catalog,
...
INSERT INTO pg_catalog.pg_views (schemaname, viewname, viewowner, definition) VALUES ('information_schema', 'routine_column_usage', 'postgres', ' SELECT DISTINCT (current_database())::information_schema.sql_identifier AS specific_catalog,
    (np.nspname)::information_schema.sql_identifier AS specific_schema,
    (nameconcatoid(p.proname, p.oid))::information_schema.sql_identifier AS specific_name,
    (current_database())::information_schema.sql_identifier AS routine_catalog,
...
INSERT INTO pg_catalog.pg_views (schemaname, viewname, viewowner, definition) VALUES ('information_schema', 'routine_routine_usage', 'postgres', ' SELECT DISTINCT (current_database())::information_schema.sql_identifier AS specific_catalog,
    (np.nspname)::information_schema.sql_identifier AS specific_schema,
    (nameconcatoid(p.proname, p.oid))::information_schema.sql_identifier AS specific_name,
    (current_database())::information_schema.sql_identifier AS routine_catalog,
...
INSERT INTO pg_catalog.pg_views (schemaname, viewname, viewowner, definition) VALUES ('information_schema', 'routine_sequence_usage', 'postgres', ' SELECT DISTINCT (current_database())::information_schema.sql_identifier AS specific_catalog,
    (np.nspname)::information_schema.sql_identifier AS specific_schema,
    (nameconcatoid(p.proname, p.oid))::information_schema.sql_identifier AS specific_name,
    (current_database())::information_schema.sql_identifier AS routine_catalog,
    (np.nspname)::information_schema.sql_identifier AS routine_schema,
...
INSERT INTO pg_catalog.pg_views (schemaname, viewname, viewowner, definition) VALUES ('information_schema', 'routine_table_usage', 'postgres', ' SELECT DISTINCT (current_database())::information_schema.sql_identifier AS specific_catalog,
    (np.nspname)::information_schema.sql_identifier AS specific_schema,
    (nameconcatoid(p.proname, p.oid))::information_schema.sql_identifier AS specific_name,
    (current_database())::information_schema.sql_identifier AS routine_catalog,
    (np.nspname)::information_schema.sql_identifier AS routine_schema,
